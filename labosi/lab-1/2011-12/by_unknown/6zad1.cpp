#include <iostream>
  ...
  void moveSquare(struct Square*, int x, int y){
    std::cerr <<"in moveSquare; pomak je "<<x<<" po x osi i "<<y<<"po y osi\n" ;
  }
  void moveCircle(struct Circle*, int x, int y){
    std::cerr <<"in moveCircle; pomak je "<<x<<" po x osi i "<<y<<"po y osi\n" ;
  }
  void moveRhomb(struct Rhomb*, int x, int y){
    std::cerr <<"in moveRhomb; pomak je "<<x<<" po x osi i "<<y<<"po y osi\n" ;
  }
